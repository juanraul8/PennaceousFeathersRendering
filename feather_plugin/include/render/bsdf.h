...
public:
    ...
    enum EBSDFType {
        ...
        // =============================================================
        //!                   User defined lobe attributes
        // =============================================================
        EBarb          = 0x20001,
        EBarbuleLeft          = 0x20002,
        EBarbuleRight          = 0x20003,
...
protected:
    ...
    //Masking variables for Feather plugin (we should probably find a better way to do this)
public:
    Float hmin = -1.0, hmax = 1.0;//Azimuthal fiber radius range
    Float a_outer = 1.0, b_outer = 1.0;//Elliptical cross section parameters
    Float a_inner = 0.0, b_inner = 0.0;//Medulla size parameters
};
